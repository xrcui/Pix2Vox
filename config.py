...
__C.DATASETS.SHAPENET.RENDERING_PATH        = '../../../Downloads/datasets/pix2vox/ShapeNet/ShapeNetRendering/%s/%s/rendering/%02d.png'
# __C.DATASETS.SHAPENET.RENDERING_PATH      = '/home/hzxie/Datasets/ShapeNet/PascalShapeNetRendering/%s/%s/render_%04d.jpg'
__C.DATASETS.SHAPENET.VOXEL_PATH            = '../../../Downloads/datasets/pix2vox/ShapeNet/ShapeNetVox32/%s/%s/model.binvox'
...
#
__C.DIR                                     = edict()
__C.DIR.OUT_PATH                            = '../../resultset/Pix2Vox/output'
